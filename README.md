...
| **Lenguaje** | JavaScript (ES6+) | React.js |
...
src/App.js: Contiene la estructura principal del CV y los estilos inline. 

Aquí debes reemplazar el texto de relleno con tu propia experiencia, educación y habilidades.
